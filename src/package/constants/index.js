...
export const DEFAULT_SHORTCUTS = {
    ...
    pastMonth: {
        text: "Last month",
        period: {
            start: dayjs(new Date(new Date().getFullYear(), new Date().getMonth() - 1, 1)).format("YYYY-MM-DD"),
            end: dayjs(new Date(new Date().getFullYear(), new Date().getMonth() - 1, 1)).endOf("month").format("YYYY-MM-DD"),
        }
    }
}