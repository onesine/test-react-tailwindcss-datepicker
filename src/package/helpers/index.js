...
export function getNumberOfDay(dayString) {
    let number = null;
...
export function loadLanguageModule (langue = "en") {
    const allLanguages = [
        "af", "am", "ar-dz", "ar-iq", "ar-kw", "ar-ly", "ar-ma", "ar-sa", "ar-tn", "ar", "az",
        "be", "bg", "bi", "bm", "bn-bd", "bn", "bo", "br", "bs",
        "ca", "cs", 'cv', "cy",
        "da", "de-at", 'de-ch', "de", "dv",
        "el", "en-au", 'en-gb', "en-ie", "en-il", "en-in", "en-nz", "en-sg", "en-tt", "en", "eo", "es-do", "es-mx", "es-pr", "es-us", "es", "et", "eu",
        "fa", "fi", 'fo', "fr-ca", "fr-ch", "fr", "fy",
        "ga", "gb", 'gl', "gom-latn", "gu",
        "he", "hi", "hr", "ht", "hu", "hy-am",
        "id", "is", "it-ch", "it",
        "ja", "jr",
        "ka", "kk", "km", "ko", "ku", "ky",
        "lb", "lo", "lt", "lv",
        "me", "mi", "mk", "ml", "mn", "mr", "ms-my", "ms", "mt", "my",
        "nb", "ne", "nl-be", "nl", "nn",
        "oc-Inc",
        "pa-in", "pl", "pt-br", "pt",
        "rn", "ro", "ru", "rw",
        "sd", "se", "si", "sk", "sl", "sq", "sr", "sr-cyrl", "sr", "ss", "sv-fi", "sv", "sw",
        "ta", "te", "tet", "tg", "th", "tk", "tl-ph", "tlh", "tr", "tzl", "tzm-latn", "tzm",
        "ug-cn", "uk", "ur", "ur-latn", "uz",
        "vi",
        "x-pseudo",
        "yo",
